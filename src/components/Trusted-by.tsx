export default function TrustedBy() {
  return (
    <section className="w-full py-[46px] px-24" style={{ backgroundColor: "#060036", height: "141px" }}>
      <div className="flex items-center justify-center gap-[70px] max-w-7xl mx-auto">
        <div className="text-white text-lg font-medium whitespace-nowrap">Trusted by</div>

        <div className="flex items-center gap-[70px]">
          {/* Shield Logo */}
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-white rounded flex items-center justify-center">
              <svg viewBox="0 0 24 24" className="w-5 h-5 text-[#060036]" fill="currentColor">
